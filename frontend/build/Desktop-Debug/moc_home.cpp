...
constexpr auto qt_meta_stringdata_CLASSHomeENDCLASS = QtMocHelpers::stringData(
    ...
    "",
    "showSignin",
    "on_signupNavButton_clicked",
    "on_signinNavButton_clicked"
);
...
Q_CONSTINIT const QMetaObject Home::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHomeENDCLASS_t,
        ...
        // method 'showSignin'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_signupNavButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_signinNavButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_signupNavButton_clicked(); break;
        case 3: _t->on_signinNavButton_clicked(); break;
        default: ;
        }
        ...
        {
            using _t = void (Home::*)();
            if (_t _q_method = &Home::showSignup; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Home::*)();
            if (_t _q_method = &Home::showSignin; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Home::showSignup()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Home::showSignin()
{
